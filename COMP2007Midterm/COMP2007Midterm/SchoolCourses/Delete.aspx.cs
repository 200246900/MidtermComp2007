...
namespace COMP2007Midterm.SchoolCourses
{
    public partial class Delete : System.Web.UI.Page
    {
        ...
        // This is the Delete methd to delete the selected SchoolCours item
        ...
        // This is the Select methd to selects a single SchoolCours item with the id
        ...
        public COMP2007Midterm.Models.SchoolCours GetItem([FriendlyUrlSegmentsAttribute(0)]int? Id)
        {
            ...
            using (_db)
            {
	            return _db.SchoolCourses.Where(m => m.Id == Id).FirstOrDefault();
            }
        }
